...
- One keyboard-controlled railway cart versus three bots
...
| Action | Keyboard |
| --- | --- |
| Choose direction at the next junction | W A S D |
| Fire | Space |
| Pause / resume | Escape |
...
| `src/players/mod.rs` | Player state, keyboard and bot input, movement, and collisions |
| `src/players/visuals.rs` | Cart and rider models |
| `src/combat.rs` | Projectiles, rear hits, and scoring |
| `src/ui.rs` | Main menu, pause dialog, and score display |
...
1. Add gamepad input and four-human local multiplayer.
2. Improve movement, hit feedback, bot behavior, and round presentation.
3. Add original character and arena art.
4. Add a WebAssembly build and automated deployment.
5. Validate Android and iOS packaging early.
